...
class DynamicPositionClip:
    ...
    def dynamicPosition(self, t, movement_model, image_width, image_height):
        x_val, y_val = movement_model.get_x_y_for_z(t)
    ...
    def generate_video(self, image_path, clip_duration, movement_model, output_path=None):
        ...
        clip = clip.set_position(lambda t: self.dynamicPosition(t, movement_model, image_width, image_height))
...
if __name__ == '__main__':
    ...
    movement_file = "spline_data_zigzag.json"
